...
class DeepSpeedRLHFEngine:
    ...
    def _init_reward(self, reward_model_name_or_path):
        ...
        reward_model = create_critic_model(
            ...
            use_multihead=self.args.use_multihead_rm,
            dcomp_config={"rm_num_heads":2}
        )
    ...
    def save_optimization_states(self, dst_path):
        ...
        self.actor.save_checkpoint(dst_path)


    def load_optimization_states(self, src_path):
        self.actor.load_checkpoint(src_path)
