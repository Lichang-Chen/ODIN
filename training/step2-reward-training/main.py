...
from utils.data.data_utils import create_prompt_dataset, DataCollatorRewardwithAttributes
...
def main():
    ...
    data_collator = DataCollatorRewardwithAttributes()
    if args.local_rank == -1:
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            correlations = []
            if args.use_decomposition or args.use_multihead:
