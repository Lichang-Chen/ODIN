...
from .multihead_rw import MultiheadRewardModel
from .two_head_rw import TwoHeadRewardModel
...
def create_critic_model(model_name_or_path,
                        ...
                        use_multihead=False,
                        use_two_head_rw=False,
                        dcomp_config: dict = None):
    ...
    if use_two_head_rw:
        critic_model = TwoHeadRewardModel(
            critic_model,
            tokenizer, 
            num_padding_at_beginning=num_padding_at_beginning,
            **dcomp_config)
    elif use_multihead:
        critic_model = MultiheadRewardModel(
            critic_model,
            tokenizer, 
            num_padding_at_beginning=num_padding_at_beginning,
            **dcomp_config)
